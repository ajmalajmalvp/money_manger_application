...
import 'package:flutter_money_mangement_application/Screens/LockScreen/lock_screen.dart';
import 'package:flutter_money_mangement_application/Screens/Settings/edit_profile.dart';
import 'package:flutter_money_mangement_application/Screens/Splash_screen/splash_screen.dart';
import 'package:flutter_money_mangement_application/Sevices/notification_searvices.dart';
...
import 'package:flutter_money_mangement_application/constents/string.dart';
import 'package:flutter_money_mangement_application/controller/lockscreen/share_preference.dart';
import 'package:flutter_money_mangement_application/controller/transactio_controller.dart';
import 'package:flutter_money_mangement_application/database/boxes.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
            ...
            SettingsSection(
                ...
                tiles: [
                  ...
                  SettingsTile(
                    title:const
                     Text("Passcode"),
                    leading: _mainController.getValuebool == true
                    ...
                    onPressed: (context) async {
                      ...
                      final boolvalue =
                          await sharedpreferences.getBool("boollocked");

                      if (boolvalue == true) {
                        final lockValue =
                            await sharedpreferences.getString("stringlokked");
                        log(boolvalue.toString() + "sample");
                        ...
                        log(boolvalue.toString() + "not");
                        screenLockCreate(
                            context: context,
                            onConfirmed: (value) async {
                              log(value);
                              final stringer = await sharedpreferences
                                  .setString("stringlokked", value);
                              final boollocked = await sharedpreferences
                                  .setBool("boollocked", true);
                              setState(() {
                                isLocked = boollocked;
                              });
  ...
  feedback() async {
    final Uri emailLaunchUri = Uri(
        scheme: 'mailto',
        path: 'computerlaplenova@gmail.com',
